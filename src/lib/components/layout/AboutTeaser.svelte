...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "George Eliadis",
		role: "Founder & CEO",
		image: "/generated/image-a-headshot-of-a-friendly-confident-male-.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`“I sat next to dispatchers answering real calls while we built this—because that’s what they deserve.”`}
			/>
